...
<h5>Line id : guitar-_-</h5>
    ...
    <form action="post_comment.php" method="post">
        <table style="height: 150px;">
            <tr>
                <td class="textbox">ชื่อติดต่อ: <?php echo $row['firstname'] . ' ' . $row['lastname'] ?></td>
                <td><textarea type="text" name="fullname" placeholder="Please enter your name" style="width: 230px; height: 30px;" hidden><?php echo $row['firstname'] . ' ' . $row['lastname'] ?></textarea></td>
            </tr>
            <tr>
